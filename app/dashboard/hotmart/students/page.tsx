        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Gerencie os alunos dos seus produtos Hotmart</p>
                </div>
                <Button
                    onClick={handleSync}
                    disabled={syncing}>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Alunos sincronizados da plataforma Hotmart</CardDescription>
                </CardHeader>
                <CardContent>
                    {students.length === 0 ? (
