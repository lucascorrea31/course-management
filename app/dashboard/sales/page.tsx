        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Acompanhe suas vendas da Kiwify</p>
                </div>
                <Button
                    onClick={handleSync}
                    disabled={syncing}>
                    ...
                    <CardContent className="pt-6">
                        <div className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-4">
                                Clique em &quot;Sincronizar&quot; para importar suas vendas dos últimos 30 dias
                            </p>
                        </div>
                    </CardContent>
                </Card>
                            ...
                            <TableBody>
                                {sales.map((sale) => (
                                    <TableRow key={sale._id}>
                                        ...
                                        <TableCell className="text-green-600">{formatPrice(sale.commission)}</TableCell>
